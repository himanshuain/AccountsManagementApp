...
const Collapsible = React.forwardRef(({ open, onOpenChange, defaultOpen = false, children, ...props }, ref) => {
  ...
  return (
    <CollapsibleContext.Provider value={{ open: openState, onOpenChange: handleOpenChange }}>
      <div ref={ref} {...props}>
        {children}
      </div>
