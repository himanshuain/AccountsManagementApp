    ...
    >
      ...
      {!isDark && (
        <div className="absolute bottom-0 left-1/2">
          <svg
            viewBox="0 0 300 500"
            className="h-[75vh] max-h-[650px] w-[60vw] max-w-[400px]"
            style={{
          ...
          >
            ...
            <g fill="url(#spiderSuit)">
              ...
              <path
                d="M112 105 Q75 70 50 25 Q43 18 38 25 Q32 38 45 52 Q70 90 100 120"
                fill="url(#spiderAccent)"
              />

              {/* Right Arm - Down/Back */}
              <path
                d="M188 105 Q215 140 240 195 Q248 210 238 218 Q225 212 218 190 Q200 150 178 118"
                fill="url(#spiderAccent)"
              />
      ...
      {isDark && (
        <div className="absolute bottom-0 left-1/2">
          <svg
            viewBox="0 0 300 500"
            className="h-[78vh] max-h-[680px] w-[60vw] max-w-[420px]"
            style={{
          ...
          >
            ...
            <g fill="url(#ironArmor)">
              ...
              {/* Face Plate */}
              <path
                d="M108 72 Q130 48 150 48 Q170 48 192 72 L192 108 Q170 120 150 120 Q130 120 108 108 Z"
                fill="url(#ironGold)"
              />
              ...
              <path
                d="M95 145 Q60 158 38 185 Q20 210 12 260 Q5 285 18 298 Q32 292 38 268 Q52 215 82 180 Q95 168 92 158"
                fill="url(#ironGold)"
              />
              ...
              {/* Right Arm */}
              <path
                d="M205 145 Q240 168 268 215 Q282 252 275 290 Q282 315 268 322 Q255 315 262 285 Q258 242 232 198 Q212 168 212 155"
                fill="url(#ironGold)"
              />
              {/* Right Repulsor */}
              <circle
      ...
      <style jsx global>{`
        @keyframes spiderSwing {
          ...
          50% {
            transform: translateX(-50%) translateY(3%) rotate(2deg);
          }
        }
        @keyframes ironFloat {
          0%,
